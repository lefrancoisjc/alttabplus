const copy = {
  en: {
    ...
    heroLede: "Native Alt+Tab lists the group and every window inside it. AltTabPlus collapses the layout into a single tile, with live previews, then gets out of the way.",
  ...
  fr: {
    ...
    heroLede: "L’Alt+Tab natif liste le groupe et chaque fenêtre. AltTabPlus replie le layout en une tuile, avec des aperçus live, puis s’efface.",
